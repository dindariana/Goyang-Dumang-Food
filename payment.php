...
<head>
 ...
 e8fa2e31b4.js" crossorigin="anonymous"></script>
...
<div class="methods">
<div onclick="doFun()" id="tColorA" style="color:
greenyelLow;"><i class="fa-solid fa-credit-card "style="color: greenyelLow;"></i> Payment by card</div>
<div onclick="doFunA()" id="tColorB"><i class="
  fa-solid fa-building-columns"></i> Internet banks</div>
  <div onclick="doFunB()" id="tColorC"><i class="
  fa-solid fa-wallet"></i> Apple/Google pay</div>
  </div>
  <hr style="border:1px solid #ccc; margin: 0 15px;">
  </div>
  <div class="center">
...
<div class="cvv-box" id="cvv-box">
  <input id="cvv" class="cc-cvv", placeholder="CVV" required maxlengths="3"required>
...
<div class="email">
<p>Email</p>
<input type="email" placeholder="examplegemail.com" id="email" required>
</div>
...
<div class="right">
  ...
  <hr style="border:1px solid #ccc; margin: 0 15px;">
  <a href="https://www.shift4shop.com/ credit-card-logos.html"><img alt="Credit Card Logos" title="Credit Card Logos" src="https:// www.shift4shop.com/images/credit-card-logos/ cc-1g-4.png" width="100%" height="auto" /></a>
</div>
 </div>
